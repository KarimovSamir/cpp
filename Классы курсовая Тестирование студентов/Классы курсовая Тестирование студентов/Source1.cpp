...
//    // если ничего не передать он удалит все незаконченные тесты, передаЄт по умолчанию "CLEAN ALL TYPE"
...
//    //_CrtDumpMemoryLeaks();
//
//    /*User_list* user = registration.Get_head();
//    User_list* temp = nullptr;
//    Test_type* test = all_test.Get_head_test_type();
//    registration.clean_TESTDATA(test);
//    while (user != nullptr)
//    {
//        registration.clean_TESTDATA(user->incomplete_test);
//        registration.clean_GRADEDATA(user);
//        temp = user;
//        user = user->next;
//        delete temp;
//        temp = nullptr;
