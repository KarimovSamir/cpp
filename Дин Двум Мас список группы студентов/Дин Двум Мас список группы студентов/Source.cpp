...
//void AddStudents(char**& arr_stings, int& num);
//void Print(char** arr_stings, int num);
//int FindStudent(char** names, int size, char* find);
//int EditStudent(char** names, int& size, char* smth, char* smth_2);
//void RemoveStudent(char**& arr, int& size, char* student);
...
//            char* smth_2 = getString();
//
//            if (EditStudent(names, size, smth, smth_2) == 0)
//            {
//                cout << "Студент не найден" << endl;
//            }
//            else
//            {
//                cout << "Имя " << smth << " изменено на " << smth_2 << endl;
//            }
//        }
//        else if (choose == 6)
//        {
